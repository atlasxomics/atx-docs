# DIY / Local Processing

For users who prefer to process data on a **local machine** rather than the Latch
cloud, ATX provides open-source tools that mirror the cloud Workflows.
